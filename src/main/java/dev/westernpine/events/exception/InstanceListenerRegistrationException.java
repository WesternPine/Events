...
public class InstanceListenerRegistrationException extends RuntimeException {
    ...
    public InstanceListenerRegistrationException(Object instance, Method method) {
        super("Method %s was registered with an incorrect instance, which requires an instance of class %s.".formatted(method.getName(), method.getClass().getName())
        + (Objects.isNull(instance) ? "(Instance was null.)" : ""));
    }
}
